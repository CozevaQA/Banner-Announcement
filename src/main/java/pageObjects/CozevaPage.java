...
//		System.out.println("roleXpath: "+roleXpath);
	...
	public boolean isTOCPresent() throws InterruptedException {
//		try {
...
//		}
		...
		try {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpaths.getProperty("TOC_page"))));
            Thread.sleep(200);
            return true;
	...
	public Boolean isToastContainerPresent() throws InterruptedException {
//		try {
...
//		}
		...
		try {
            ...
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(xpaths.getProperty("toast_message_container"))));
            Thread.sleep(200);
            return true;
        } catch (Exception e) {
            Thread.sleep(500);
